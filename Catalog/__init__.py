...
# this is csrf security extension - used to be flask.ext.seasurf
...
engine = create_engine('postgresql://catalog:Udacity1!@localhost/sports')
...
def fbconnect():
    ...
    app_id = json.loads(open('/var/www/Catalog/Catalog/fb_client_secret.json', 'r').read())[
        'web']['app_id']
    app_secret = json.loads(
        open('/var/www/Catalog/Catalog/fb_client_secret.json', 'r').read())['web']['app_secret']
