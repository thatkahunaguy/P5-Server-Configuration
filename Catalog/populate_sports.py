...
item1 = Item(user_id=1, 
             ...
             description= "Began playing at age 3.  Mother, Judy, is current British Fed Cup captain. Has 1 older brother Jamie (born Feb. 13, 1986), who also plays on the ATP circuit.  Was once offered trials with Glasgow Rangers FC",
             category=category1)
